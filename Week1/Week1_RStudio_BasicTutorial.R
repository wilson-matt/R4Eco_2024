...
df[c("Brighton"),]
df[,c("Fibonacci")]
  # Notice the use of c(), quotes, and comma placement. All are critical if you want to select by name(s)
...
#How do you know this line worked? By checking with GET Working Directory function getwd():
getwd() 
...
#Because this is not a built-in function of R, you will need to rerun it every time you reopen R to re-add it to your global environment.
  #This is only for the mac users among you...don't worry about it if you have a PC.
...
smart_wd(repo = "R4Eco_2024", folder = "Week1")
